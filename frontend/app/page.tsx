...
import { assessContent, type AssessResponse, type Channel } from "@/lib/api";
...
export default function Page() {
  ...
  return (
    <main className="mx-auto max-w-4xl p-6">
      ...
      <div className="mt-6 grid gap-4 rounded-xl border bg-white p-5 shadow-sm">
